        ...
        <div className="about-story-inner">
          ...
          <div className="glass-strong about-story-card">
            ...
            <p>
              ...
              (2015–2020, 29,531 rows) covering 9 pollutants across 26 cities. The model achieves
              R²=0.932 — meaning it explains 93.2% of AQI variance. SHAP values make every prediction
              explainable.
            </p>
          </div>
          <div className="glass-strong about-story-card">
      ...
      <section className="about-data">
        <div className="glass-strong about-data-card">
          ...
          <div className="model-card-grid">
            ...
            <div className="mc-row"><span className="mono mc-key">TRAINING DATA</span><span className="mc-val">CPCB, 2015–2020 · 29,531 rows · 26 cities</span></div>
